...
from i3d_src.i3d_s112 import I3D, Unit3Dpy
from i3d_src.DataLoader_s112_k400_ge128 import RGB_jpg_train_Dataset, RGB_jpg_val_Dataset
Num_Frames = 128
Batch_Size = 8
Num_Workers = 12
s0 = "i3dm_s112_d1_f{}_k400_".format(Num_Frames)

data_dir = Path("data/k400_imgs")    
data_json_dir = "data/k400_imgs/data_json_ge128"
num_sub_dataset = 1

weight_path = "weights/i3d_s112_k400_d1_f128_val_acc_0.6002.pth"
        ...
        for i in range(start_sub_epoch, len_train_loader):    
            ...
            for phase in ['train', 'val']:
                ...
                if phase == 'val':
                    ...
                    s1 = s0 + d_t + "_"         
                    temp_model_path = str(save_path)+s1+"{}_lr{:e}_e{}_i{}_acc{:.4f}_{:.4f}.pth".\
...
def load_and_freeze_model(model, num_classes, num_freeze=11):
...
def main(train_data_loaders, val_data_loader, train_dataset_sizes, val_dataset_size):
    ...
    log("lr_scheduler: step_size={}, gamma={}\n".format(step_size, gamma))
